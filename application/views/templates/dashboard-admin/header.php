    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li><a href="<?php echo site_url('admin');?>"><i class="fa fa-home" aria-hidden="true"></i> Dashboard</a></li>
                <li><a href="<?php echo site_url('admin/users');?>"><i class="fa fa-users" aria-hidden="true"></i> Manage Users</a></li>
                <li><a href="<?php echo site_url('admin/templates');?>"><i class="fa fa-file" aria-hidden="true"></i> Manage Templates</a></li>
                <li><a href="<?php echo site_url('admin/question_bank');?>"><i class="fa fa-university" aria-hidden="true"></i> Question Bank</a></li>
